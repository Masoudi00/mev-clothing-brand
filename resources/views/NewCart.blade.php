...
<div class="container mt-5 text-white test">
    ...
    <div class="row ">
        <div class="col-md-6 col-lg-6 mb-4 ">
             <ul class="list-group mt-5">
                ...
                <li class="d-flexe align-items-center mb-3">
                    <div id="imageCarousel{{$id}}" class="carousel slide" data-bs-ride="carousel" style="width: 200px; height: 200px;">
                        <div class="carousel-inner border border-secondary rounded mt-2">
                            <div class="carousel-item active">
                                <img src="{{ asset('imgs/' . $details['image']) }}" alt="First Image" class="d-block w-100" style="height: 200px;">
                            </div>
                            @if(isset($details['image2']))
                            <div class="carousel-item">
                                <img src="{{ asset('imgs/' . $details['image2']) }}" alt="Second Image" class="d-block w-100" style="height: 200px;">
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <span class="ms-5 mt-3">
                        <h2 class="text-white">{{ $details['name'] }} - <span>{{ $details['size'] }}</span></h2>
        ...
        <div class="col-md-6 col-lg-6 checkoutform border border-secondary rounded">
            <form id="buyerInfoForm" method="POST" action="{{ route('orders.store') }}">
                ...
                <div class="m-5">
                    <label for="email" class="text-white mb-2">Email Addres:</label>
                ...
                <div class="m-5">
                    <label for="zipcode" class="text-white mb-2">ZipCode:</label>
